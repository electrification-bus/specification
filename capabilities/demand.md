...
This document is the canonical property catalog for the `demand` capability. Data-model documents that use it (today [`utility-meter.md`](../devices/utility-meter.md)) reference this catalog.
